...
import healthyHeaven.restaurant.Restaurant;
import healthyHeaven.restaurant.Salad;
import healthyHeaven.restaurant.Vegetable;
...
// Initialize the second entities
        Vegetable corn = new Vegetable("Corn", 12);
        ...
        System.out.println(restaurant.getHealthiestSalad().getName()); // Tomatoes with cucumbers
