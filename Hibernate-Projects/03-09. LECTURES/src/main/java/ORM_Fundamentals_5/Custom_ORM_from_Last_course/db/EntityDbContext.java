package ORM_Fundamentals_5.Custom_ORM_from_Last_course.db;
...
public class EntityDbContext<T> implements DbContext<T> {
    ...
    private List<T> find(String template, String where) throws SQLException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        String queryString = MessageFormat.format(
            template,
            getTableName(),
            where
